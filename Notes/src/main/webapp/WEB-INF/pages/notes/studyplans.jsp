...
<body>
	...
	<div class="modal fade" id="addStudyPlanModal" tabindex="-1">
		<div class="modal-dialog">
			<div class="modal-content">
				<form class="form-horizontal" action="${WEBPATH }/addStudyPlan"
					method="post">
	...
	<!--  这是用户编辑 -->
	<div class="modal fade" id="updateStudyPlanModal" tabindex="-1">
		<div class="modal-dialog">
			<div class="modal-content">
				<form class="form-horizontal" action="${WEBPATH }/updateStudyPlan"
					method="post">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal">&times;</button>
		...
		<div class="jumbotron">
			<div class="row">
				<a class="btn btn-success" data-toggle="modal"
					data-target="#addStudyPlanModal">新增</a> <a class="btn btn-danger"
					id="deleteStudyPlans">删除</a>
	...
	<script type="text/javascript">
		...
		function getPlan(id) {
			$.ajax({
				url : "${WEBPATH}/findStudyPlan?id=" + id,
				type : "GET",
		...
		$("#deleteStudyPlans").click(function() {
			var titles = "";
			var ids = "";
			...
			if (confirm("确认删除[" + titles + "]吗?")) {
				location.href = "${WEBPATH }/deleteStudyPlans?ids=" + ids;
			}
		});
		$(".delete_btn").click(function() {
			id = $(this).parents("tr").find("td:eq(1)").text();
			if (confirm("确认删除吗？")) {
				location.href = "${WEBPATH }/deleteStudyPlan?id=" + id;
			}
		});
	</script>
</body>
